...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#FDFCFB] text-[#333] font-sans selection:bg-[#4A5D4E] selection:text-white">
      ...
      {/* --- HERO SECTION --- */}
      <section className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-6 md:px-16 py-16 md:py-28 gap-12 text-center md:text-left">
        <div className="md:w-1/2 space-y-8 order-2 md:order-1">
          <h1 className="text-5xl md:text-7xl font-serif leading-[1.1] text-[#2C362F]">
            Healing <br /> 
      ...
      {/* --- CLINICAL SPECIALITIES SECTION (Bigger Images) --- */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { 
                t: "Anxiety & Panic", 
                d: "Specialized support for high-achievers who feel 'functional' but struggle with constant worry and overthinking.", 
                img: "https://images.pexels.com/photos/5699435/pexels-photo-5699435.jpeg?auto=compress&cs=tinysrgb&w=800" 
              },
              { 
                t: "Trauma & EMDR", 
                d: "Using evidence-based EMDR and body-oriented techniques to help you process past experiences safely.", 
                img: "https://images.pexels.com/photos/7176030/pexels-photo-7176030.jpeg?auto=compress&cs=tinysrgb&w=800" 
              },
              { 
                t: "Professional Burnout", 
                d: "Helping entrepreneurs and professionals reconnect with themselves and develop sustainable ways of working.", 
                img: "https://images.pexels.com/photos/7176319/pexels-photo-7176319.jpeg?auto=compress&cs=tinysrgb&w=800" 
              }
            ].map((s, i) => (
              <div key={i} className="bg-[#EAE5DF] p-8 flex flex-col items-center text-center space-y-8 rounded-sm hover:shadow-2xl transition-all group border border-transparent hover:border-[#4A5D4E]/10">
                ...
                {/* BIGGER CIRCULAR IMAGE: Increased to w-72 h-72 */}
                <div className="w-64 h-64 md:w-72 md:h-72 rounded-full overflow-hidden border-[6px] border-white shadow-2xl transition-transform duration-700 group-hover:scale-105">
   ...
   {/* --- OUR OFFICE: MOBILE-FIRST HEADING ORDER --- */}
      <section id="office" className="py-24 px-6 md:px-16 bg-[#F4F1EE] overflow-hidden">
        <div className="max-w-7xl mx-auto">
          {/* flex-col-reverse for mobile (Text first), flex-row for desktop (Image first) */}
          <div className="flex flex-col-reverse lg:flex-row gap-16 lg:gap-20 items-center">
            
            {/* Left Side: Image Stack (Ab ye mobile pe niche dikhega) */}
            <div className="w-full lg:w-1/2 relative flex flex-col items-center">
              <div className="relative z-10 w-full md:w-4/5 aspect-[4/5] rounded-sm shadow-2xl overflow-hidden border-[8px] border-white">
                <img src="/office1.jpeg" className="w-full h-full object-cover" alt="Dr. Maya's Space" />
              </div>
              
              <div className="relative mt-6 md:mt-0 md:absolute md:-bottom-12 md:-right-4 z-20 w-full md:w-3/5 aspect-square rounded-sm shadow-2xl overflow-hidden border-[6px] border-white">
                <img src="/office2.jpeg" className="w-full h-full object-cover" alt="Office Interior" />
              </div>
            </div>

            {/* Right Side: Heading & Text (Ab ye mobile pe sabse pehle dikhega) */}
            <div className="w-full lg:w-1/2 space-y-8">
              ...
              <div className="space-y-6 text-gray-600 font-light leading-relaxed">
                ...
                <div className="bg-white/60 backdrop-blur-sm p-6 border-l-4 border-[#4A5D4E] shadow-sm">
      ...
      {/* --- FAQ SECTION (Requirement Fulfillment) --- */}
      <section id="faqs" className="py-24 px-6 md:px-16 bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-[10px] uppercase tracking-[0.4em] text-[#4A5D4E] font-bold block mb-4">Common Questions</span>
            <h2 className="text-4xl font-serif text-[#2C362F] italic">Frequently Asked Questions</h2>
          </div>
            ...
            {[
              {
                ...
                a: "I offer both. My physical office is located in Santa Monica for those who prefer in-person connection, and I also provide secure, HIPAA-compliant telehealth sessions for clients across California."
              },
              {
                q: "What can I expect in the first session?",
                a: "Our first meeting is a consultation where we'll discuss your history, current challenges, and goals. It’s a space for us to see if we’re a good fit and for you to ask any questions about my approach."
              },
              {
                q: "Do you take insurance?",
                a: "I am an out-of-network provider. This allows us more privacy and flexibility in your treatment. I can provide you with a 'superbill' that you can submit to your insurance for potential reimbursement."
              },
              {
                q: "How long does therapy usually last?",
                a: "This varies for everyone. Some clients find relief in short-term, goal-focused work, while others prefer longer-term depth therapy for trauma and deeper self-exploration."
              }
            ].map((faq, i) => (
              <div key={i} className="border-b border-gray-100 pb-8">
                <h3 className="text-lg font-serif text-[#2C362F] mb-3">{faq.q}</h3>
